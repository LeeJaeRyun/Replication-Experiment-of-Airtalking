...
<!-- AUTO: enhanced_semantic_profile_summary -->
...
<!-- AUTO: enhanced_reproduction_provenance -->
...
<!-- AUTO: enhanced_airtalking_command -->
...
<!-- AUTO: enhanced_paperlike_codec_for_simulator -->

### 12.2 Semantic 5개 면적×5개 정책과 300 m nonsemantic 4개 정책 결과

<!-- AUTO: enhanced_airtalking_full_results -->

### 12.3 기존 profile 대비 변화

<!-- AUTO: enhanced_vs_legacy_system_delta -->

### 12.4 Fig. 3~6 verifier

<!-- AUTO: enhanced_paper_verification_counts -->
...
<!-- AUTO: strengthened_reproduction_sensitivity_results -->
